...
namespace Exploder
{
    ...
    public class ExploderObject : MonoBehaviour
    {
        ...
        /// </summary>
        public ThreadOptions ThreadOption = ThreadOptions.WorkerThread_3x;
        ...
        {
            core.Enqueue(this, callback, null);
        }
        ...
        {
            core.Enqueue(this, callback, obj);
        }
...
//        }
        ...
        {
            ExploderUtils.Assert(!core.crack, "Another crack in progress!");

            if (!core.crack)
            {
                core.crack = true;
                core.cracked = false;
                ExplodeRadius(callback);
            }
        }
        ...
        {
            ExploderUtils.Assert(core.crack, "You must call Crack() first!");

            if (core.cracked)
            {
                core.ExplodeCracked(callback);
                core.crack = false;
            }
        }
