...
namespace Exploder
{
    ...
    class ExploderQueue
    {
        ...
        public void Enqueue(ExploderObject exploderObject, ExploderObject.OnExplosion callback, GameObject target)
        {
        ...
        public void OnExplosionFinished(int id, long ellapsedMS)
        {
            ...
            {
                explosion.Callback(ellapsedMS, core.crack ? ExploderObject.ExplosionState.ObjectCracked : ExploderObject.ExplosionState.ExplosionFinished);
            }
