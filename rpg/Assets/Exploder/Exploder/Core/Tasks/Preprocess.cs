...
namespace Exploder
{
    class Preprocess : ExploderTask
    {
        ...
        {
            Core.targetFragments = new int[64];
        }
        ...
        {
            base.Init();
            Array.Clear(core.targetFragments, 0, core.targetFragments.Length);
        }
        ...
        public override bool Run(float frameBudget)
        {
            ...
            core.meshSet = new HashSet<MeshObject>(meshList);
        ...
        private List<MeshObject> GetMeshList()
        {
            ...
            if (core.targetFragments.Length <= list.Count)
            {
                core.targetFragments = new int[list.Count];
            }
